...
class GUI:
    ...
    def start_receiver(self):
        ...
        try:
            self.receiver_module.connect_to_sender(
                self.sender_ip_entry.get(), int(self.sender_port_entry.get()))
    ...
    def start_sender(self):
        ...
        try:
            ...
            self.sender_address_text['text'] = f"{self.sender_module.sender_address} @ port {self.sender_module.sender_port}"
        except:
        ...
        if(hasattr(self.sender_module, "audio_stream")):
    ...
    def threaded_stop_sender(self):
        self.sender_address_text['text'] = "Unavailable"
    ...
    def stop_sender(self):
        ...
        self.send_start_button['state'] = tk.ACTIVE
        self.send_stop_button['state'] = tk.DISABLED
